...
function Editclient() {
  ...
  function handleSubmit(event) {
    ...
    axios.put(`http://localhost:8081/edit_cli/${idcli}`, { idcli, nom, adresse, contact})
      .then(res => {
        if (res.data.Status === "succes") {
          Swal.fire({
            icon: 'success',
    ...
    <div>
      ...
      <header>
        <div className="container">
          <div id="branding">
            <h1><span className="highlight">CLIENT</span> </h1>
