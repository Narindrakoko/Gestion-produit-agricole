...
import legume from './sary/fruit1.jpg'
import legume2 from './sary/fruit2.jpg'
import petit from './sary/orangier.webp'
import vomaina from './sary/fruit3.jpg'
import tsaramaso from './sary/fruit4.jpg'
import haricotvert from './sary/fruit5.jpg'
...
useEffect(() => {
    const fetchData = async () => {
        try {
            const response = await axios.get("http://localhost:8081/produit01");
...
<IconButton aria-label="cart" onClick={handleSubmit} >
      <StyledBadge badgeContent={numberOfLines} color="secondary">
                  ...
                  <div class="card mb-3 bg-transparent" style={{ borderStyle: 'none' }}>
                    <div style={{ marginBottom: '2%' }}>
                      ...
                      <Nav fill variant="tabs" defaultActiveKey="/content">
                        ...
                        <Nav.Item className='ct1'>
                          <Link to="/content2" className="p-1 fs-4 " style={{ color: 'black', background: '#217e38', textDecoration: 'none', padding: '10%', transition: 'color 0.3s' }} hover={{ color: 'black', backgroundColor: 'initial' }}>
                            <span className="fs-5" >Fruits</span>
                          </Link>
                        </Nav.Item>
                        <Nav.Item className='ct1'>
                          <Link to="/content3" className="p-1 fs-4" style={{ color: '#2C2D30', textDecoration: 'none', padding: '10%', transition: 'color 0.3s' }} hover={{ color: 'black', backgroundColor: 'initial' }}>
        ...
        {produits.map((produit) => {
            ...
            } else if (produit.prod === 'Mangue') {
                return (
                  <Card  style={{ width: '15rem', marginInline: '4%', marginTop: '2%' }}>
                     <StyledBadge1 badgeContent={produit.qt} color="secondary">
                  </StyledBadge1>
                  <img src={haricotvert} alt="Mangue" />
                  <Card.Body>
                    <Card.Title style={{ fontSize: '1.2rem' }}>{produit.prod}</Card.Title>
                    <Card.Text>
                      {produit.prix} ariary/KG
            ...
            } else if (produit.prod === 'Orange') {
              return (
                <Card  style={{ width: '15rem', marginInline: '4%', marginTop: '2%' }}>
                   <StyledBadge1 badgeContent={produit.qt} color="secondary">
                  </StyledBadge1>
                <img src={petit} alt="orange" />
                <Card.Body>
                  <Card.Title style={{ fontSize: '1.2rem' }}>{produit.prod}</Card.Title>
                  <Card.Text>
                    {produit.prix} ariary/KG
          ...
          } else if (produit.prod === 'Poire') {
            return (
              <Card  style={{ width: '15rem', marginInline: '4%', marginTop: '2%' }}>
                 <StyledBadge1 badgeContent={produit.qt} color="secondary">
                  </StyledBadge1>
              <img src={vomaina} alt="poire" />
              <Card.Body>
                <Card.Title style={{ fontSize: '1.2rem' }}>{produit.prod}</Card.Title>
                <Card.Text>
                  {produit.prix} ariary/KG
        ...
        } else if (produit.prod === 'Paiso') {
          return (
            <Card  style={{ width: '15rem', marginInline: '4%', marginTop: '2%' }}>
               <StyledBadge1 badgeContent={produit.qt} color="secondary">
                  </StyledBadge1>
            <img src={tsaramaso} alt="Paiso" />
            <Card.Body>
              <Card.Title style={{ fontSize: '1.2rem' }}>{produit.prod}</Card.Title>
              <Card.Text>
                {produit.prix} ariary/KG
      ...
      } else if (produit.prod === 'Banane') {
        return (
          <Card  style={{ width: '15rem', marginInline: '4%', marginTop: '2%' }}>
             <StyledBadge1 badgeContent={produit.qt} color="secondary">
                  </StyledBadge1>
          <img src={legume2} alt="banane" />
          <Card.Body>
            <Card.Title style={{ fontSize: '1.2rem' }}>{produit.prod}</Card.Title>
            <Card.Text>
              {produit.prix} ariary/KG
